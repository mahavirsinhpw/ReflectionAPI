...
//			System.out.println(Modifier.PUBLIC);
			...
			for(int i =0; i<m.length; i++) {
				System.out.println(m[i].getModifiers() +" Type : "+m[i].getExceptionTypes()+" Name :"+m[i].getName());
			}
			
			System.out.println("*****\n");
			Method [] md = cls.getDeclaredMethods();
			for(int i =0; i<md.length; i++) {
				System.out.println(md[i].getModifiers() +" Type : "+md[i].getExceptionTypes()+" Name :"+md[i].getName());
			}
